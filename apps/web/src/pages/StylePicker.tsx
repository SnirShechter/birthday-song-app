...
import { MUSIC_STYLES, type MusicStyle } from "@birthday-song/shared";
      ...
      >
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            >
              {t("style.title", "Choose a Style")}
            </GradientText>
            <p className="mx-auto max-w-md text-[var(--text-muted)]">
              {t(
                "style.subtitle",
                "Each style gives your song a unique feel. Pick the one that matches their personality."
              )}
            </p>
          </motion.div>
              ...
              return (
                <motion.div key={style.id} variants={cardVariants}>
                  <Card
                    ...
                    className={cn(
                      "relative flex flex-col items-center p-6 text-center transition-all duration-300",
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        "bg-[radial-gradient(circle_at_center,var(--color-primary)/10_0%,transparent_70%)]",
                        "group-hover:opacity-100"
                      )}
                    />

                    <motion.span
                      className="mb-4 block text-5xl sm:text-6xl"
